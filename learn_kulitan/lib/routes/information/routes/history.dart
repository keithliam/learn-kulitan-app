...
class HistoryPage extends StatelessWidget {
  ...
  TextSpan _italicRomanText(String text) => TextSpan(text: text, style: textInfoTextItalic);

  TextSpan _kulitanText(String text) => TextSpan(text: text, style: kulitanInfoText);
      ...
      children: <Widget>[
        ...
        Paragraphs(
          paragraphs: [
            TextSpan(
              children: <TextSpan>[
                _romanText('Long before the idea of a Filipino nation was even conceived, the Kapampangan, Butuanon, Tausug, Magindanau, Hiligaynon, Sugbuanon, Waray, Iloko, Sambal and many other ethnolinguistic groups within the archipelago, already existed as '),
        ...
        Paragraphs(
          paragraphs: <TextSpan>[
            TextSpan(
              children: <TextSpan>[
                _romanText('The Kapampangan nation was once a part of the Kingdom of Luzon [Fig. 1]. They were one of the '),
                _italicRomanText('Luçoes'),
                _romanText(', ‘people of Luzon’, encountered by Portuguese explorers during their initial ventures into Southeast Asia in the early 16th century (Scott, 1994). The Kapampangan homeland, '),
        ...
        Paragraphs(
          paragraphs: <TextSpan>[
            TextSpan(
              children: <TextSpan>[
                _romanText('If the Kapampangan nation made up the bulk of the population of the Kingdom of Luzon, then perhaps the oldest evidence of Kapampangan writing can be found in the jars (呂宋壺) exported to Japan prior to the arrival of the Spaniards in the 16th century C.E. [Fig. 3]. In his book '),
                _italicRomanText('Tokiko'),
                _romanText(' (陶器考) or “Investigations of Pottery” published in 1853 C.E., Tauchi Yonesaburo (田内米三郎) presents several jars marked with the '),
                _italicRomanText('ruson koku ji'),
                _romanText(' (呂宋國字) or the “writing of the Kingdom of Luzon” (Tauchi [田内], 1853 and Cole, 1912). The marks that looked like the Chinese character '),
                _italicRomanText('ting'),
                _romanText(' (丁) found in several Luzon jars might have been the indigenous Kapampangan script '),
                _italicRomanText('la'),
                _romanText(' ('),
                _kulitanText('la'),
                _romanText('), the first syllable in the name “Luzon” [Fig. 4].'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Writing has always been a testament to civilization among the great nations. The Chinese write ‘civilization’ as '),
                _italicRomanText('wénmíng'),
                _romanText(' (文明) or ‘enlightenment through writing’, combining the characters '),
            ...
            TextSpan(
              children: <TextSpan>[
                ...
                _italicRomanText('w'),
                _romanText('. Instead of being forced to choose which orthography to use in writing Kapampangan, they chose to forego the use of the Latin script altogether. They decided instead to go back to writing in the indigenous '),
      ...
      children: <Widget>[
        Paragraphs(
          ...
          paragraphs: <TextSpan>[
            TextSpan(
              children: <TextSpan>[
                _romanText('Avila, Bobit. (2007 August 24). Ethnic cleansing our own Filipino brethren? In '),
                _italicRomanText('The Philippine Star. Retrieved 2012 March 16 from http://www.philstar.com/Article.aspx?articleId=15037.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Beyer, Henry Otley. (1918). '),
                _italicRomanText('Ethnography of the Pampangan People: A Comprehensive Collection of Original Sources.'),
            ...
            TextSpan(
              children: <TextSpan>[
                ...
                _italicRomanText('Historia geográfica, geológica y estadistica de Filipinas.'),
            ...
            TextSpan(
              ...
              children: <TextSpan>[
                ...
                _romanText(' Field Museum of Natural History Anthropological Series,Vol. 12 (1), Chicago.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Constitution of the Republic of the Philippines (1987). In '),
                _italicRomanText('Chan Robles Virtual Law Library. '),
                _romanText(' Retrieved June 6, 2009 from '),
                _romanText('http://www.chanrobles.com/article14language.htm',
                  TapGestureRecognizer()..onTap = () => _openURL('http://www.chanrobles.com/article14language.htm'),
                ),
                _romanText('.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Defenders of the Indigenous Languages of the Archipelago (DILA). (2007). '),
                _italicRomanText('Filipino is not our language.'),
                _romanText(' Angeles City, Pampanga: Defenders of the Indigenous Languages of the Archipelago (DILA).'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Del Corro, Anicia. (2000). '),
                _italicRomanText('Language Endangerment and Bible Translation.'),
                _romanText(' Malaga, Spain: Universal Bible Society Triennial Translation Workshop.'),
              ],
            ),
            _romanText('Dizon, Eusebio et al. (5 October 1999).  Southeast Asian Protohistoric Archaeology at Porac, Pampanga, Central Luzon, Philippines. Mid-Year Progress Report. Archaeological Studies Program. University of the Philippines at Diliman, Quezon City, Philippines.'),
            TextSpan(
              children: <TextSpan>[
                _romanText('Henson, Mariano A. (1965). '),
                _italicRomanText('The Province of Pampanga and Its Towns: A.D. 1300-1965.'),
                _romanText(' 4th ed. revised. Angeles City: Mariano A. Henson.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Larkin, John A. (1972). '),
                _italicRomanText('The Pampangans: Colonial Society in a Philippine Province.'),
                _romanText(' 1993 Philippine Edition. Quezon City: New Day Publishers.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Loarca, Miguel de. (1583) Relacion de las Yslas Filipinas. In E. Blair and J. Robertson, eds. and trans. '),
                _italicRomanText('The Philippine Islands, 1493-1898'),
                _romanText(', volume 5, page 34 – 187.'),
              ],
            ),
            _romanText('Mallat, Jean. (1846). Les Philippines: histoire, geographie, mœurs, agriculture, industrie, commerce des colonies Espagnoles dans l’Oceanie. Paris: Arthus Bertrand. [English ed. 1998] Santillan, P. and Castrence, L. (Transl.), Manila: National Historical Institute.'),
            TextSpan(
              children: <TextSpan>[
                _romanText('Mantawe, Herb. (1998). '),
                _italicRomanText('Ethnic Cleansing in the Philippines.'),
                _romanText(' [2012 March 11 ed.]. Retrieved March 23, 2012 from '),
                _romanText('http://dila.ph/ethnic.pdf',
                  TapGestureRecognizer()..onTap = () => _openURL('http://dila.ph/ethnic.pdf'),
                ),
                _romanText('.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                ...
                _italicRomanText('A Country of Our Own: Partitioning the Philippines.'),
            ...
            TextSpan(
              children: <TextSpan>[
                ...
                _romanText('Informe sobre el estado de las Islas Filipinas en 1842',
                  TapGestureRecognizer()
                    ..onTap = () => _openURL('https://books.google.com.ph/books?id=rbM9AAAAIAAJ&printsec=frontcover&source=gbs_ge_summary_r&cad=0#v=onepage&q&f=false'),
                ),
            ...
            TextSpan(
              children: <TextSpan>[
                _romanText('Murillo Velarde, Pedro. (1744). Mapa de las islas Filipinas. In '),
                _italicRomanText('The Norman B. Leventhal Map Center at the Boston Public Library.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Pangilinan, Michael R.M. (2006a) '),
                _romanText('Kapampángan or Capampáñgan: Settling the Dispute on the Kapampángan Romanized Orthography',
                  TapGestureRecognizer()
                    ..onTap = () => _openURL('https://sil-philippines-languages.org/ical/papers/pangilinan-Dispute%20on%20Orthography.pdf'),
                ),
                _romanText('. A paper presented at the 10th International Conference on Austronesian Linguistiics, Puerto Princesa, Palawan, Philippines. January 2006.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Pangilinan, Michael R.M. (2009b). '),
                _romanText('Kapampangan lexical borrowing from Tagalog: endangerment rather than enrichment',
                  TapGestureRecognizer()
                    ..onTap = () => _openURL('https://www.academia.edu/5419261/Kapampangan_Lexical_Borrowing_from_Tagalog_Endangerment_rather_than_Enrichment'),
                ),
                _romanText('. A paper presented at the 11th International Conference on Austronesian Linguistics, June 21 – 25, 2009, Aussois, France.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('San Agustin, Gaspar de. (1699). '),
                _italicRomanText('Conquistas de las Islas Philipinas 1565-1615.'),
                _romanText(' [1998 Bilingual Ed.: Spanish & English] Translated by Luis Antonio Mañeru. Published by Pedro Galende, OSA: Intramuros, Manila.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('San Antonio, Juan Francisco de. (1738-1744). '),
                _italicRomanText('Cronicas de la apostolic provincial de S. Gregorio de religiosos de n.s.p. San Francisco en las islas Philipinas, China, Japon.'),
                _romanText(' Sampaloc: Juan del Sotillo.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Santiago, Luciano P.R. (1990a) The Houses of Lakandula, Matanda, and Soliman [1571-1898]: Genealogy and Group Identity. In '),
                _italicRomanText('Philippine Quarterly of Culture and Society,'),
            ...
            TextSpan(
              children: <TextSpan>[
                ...
                _italicRomanText('Prehispanic Source Materials for the Study of Philippine History.'),
                _romanText(' Quezon City: New Day Publishers.'),
              ],
            ),
            _romanText('Scott, William Henry. (1994). Barangay: Sixteenth-Century Philippine Culture and Society, Quezon City: Ateneo de Manila University Press.'),
            TextSpan(
              children: <TextSpan>[
                _romanText('Tauchi Yonesaburo (田内米三郎). (1853). Toukikou (陶器考: Investigations of Pottery). '),
            ...
            TextSpan(
              children: <TextSpan>[
                _romanText('Tayag, Katoks (Renato). (1985). The Vanishing Pampango Nation. '),
                _italicRomanText('Recollections & Digressions.'),
                _romanText(' Escolta, Manila: Philnabank Club c/o Philippine National Bank.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Wang, Teh-Ming (王徳明). (1989). '),
                _italicRomanText('Sino Suluan Historical Relations in Ancient Texts.'),
                _romanText(' (Doctoral dissertation, University of the Philippines, Diliman, Quezon City, 2001). Unpublished typescript.'),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                _romanText('Wang, Zhenping. (2008). Reading Song-Ming Records on the Pre-colonial History of the Philippines. '),
            ...
            TextSpan(
              children: <TextSpan>[
                _romanText('Wade, Geoff. [tr.] (2005) Southeast Asia in the Ming Shi-lu: an open access resource. Singapore: Asia Research Institute and the Singapore E-Press, National University of Singapore: '),
                _romanText('http://epress.nus.edu.sg/msl/place/1062',
                  TapGestureRecognizer()..onTap = () => _openURL('http://epress.nus.edu.sg/msl/place/1062'),
                ),
              ],
            ),
            TextSpan(
              children: <TextSpan>[
                ...
                _italicRomanText('Dong Xi Yang Gao [東西洋考] (A study of the Eastern and Western Oceans). '),
                _romanText('http://www.lib.kobe-u.ac.jp/directory/sumita/5A-161/index.html',
                  TapGestureRecognizer()..onTap = () => _openURL('http://www.lib.kobe-u.ac.jp/directory/sumita/5A-161/index.html'),
                ),
