...
class HistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget _history = Container(
      width: double.infinity,
      padding: const EdgeInsets.fromLTRB(
    ...
    final Widget _references = Padding(
      padding: const EdgeInsets.fromLTRB(
        informationHorizontalScreenPadding,
            ...
            paragraphs: <TextSpan>[
              ...
              TextSpan(
                children: <TextSpan>[
                  ...
                  TextSpan(
                      text: ' Vol. 1& 2. Manila, Philippines. [Microfilm].'),
                ],
              ),
              TextSpan(
                children: <TextSpan>[
              ...
              TextSpan(
                children: <TextSpan>[
                  ...
                  TextSpan(
                      ...
                      style: textInfoTextItalic),
                  TextSpan(
                      text: ' Los Angeles, California, USA: Bisaya Books.'),
                ],
              ),
              TextSpan(
                children: <TextSpan>[
              ...
              TextSpan(
                children: <TextSpan>[
                  TextSpan(
                      text: 'San Antonio, Juan Francisco de. (1738-1744). '),
                  TextSpan(
                      text:
              ...
              TextSpan(
                children: <TextSpan>[
                  ...
                  TextSpan(
                      text:
                          ' English Translation in Cole, Fay–Cooper. (1912).'),
                ],
              ),
              TextSpan(
                children: <TextSpan>[
